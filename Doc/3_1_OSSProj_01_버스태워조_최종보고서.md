...
2. 스타일 선택 화면  
<img src="imgs/최종보고서_img/2-1.스타일선택.png" alt="스타일 선택화면1" height=400>
  <img src="imgs/최종보고서_img/2-2.스타일선택.png" alt="스타일 선택화면2" height=400>
...
4. 스타일추천 화면  
    ...
    - 이미지를 선택하면 해당 쇼핑몰 사이트로 연결된다.  
  4-1. 찜하기 기능   
    <img src="imgs/최종보고서_img/4-2.추천스타일찜.png" alt="스타일찜" height=400>
    <img src="imgs/최종보고서_img/4-3.찜목록.png" alt="찜목록" height=400>
  ...
  5. 오늘 뭐입지? 화면  
      ...
      <img src="imgs/최종보고서_img/5-2.쇼핑몰이동화면.png" alt="쇼핑몰이동_랜덤" height=400>  
      - 랜덤 스타일 추천 화면으로, 해당 화면 접속마다 스타일이 랜덤하게 바뀐다.
      - '스타일 보러 가기' 버튼 선택하면 해당 스타일의 쇼핑몰 사이트로 연결된다.
